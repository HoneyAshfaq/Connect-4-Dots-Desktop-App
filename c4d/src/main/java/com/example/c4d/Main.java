...
public class Main extends Application {
	...
	private void aboutMe() {
		...
		alert.setHeaderText("Honey Ashfaq");
		alert.setContentText("Hi i am Honey, a aspiring software developer. I am an B.tech" +
	...
	private void aboutConnect4() {
		...
		String s = String.format("The Connect 4 Game Rules are easy to understand." +
